...
var kundenprep = Enumerable.Zip(Enumerable.Range(1, kundentxt.Length - 1), kundentxt.Skip(1).Select(Transformations.ReturnMatchesKunde));
...
var ortListprep = Enumerable.Zip(Enumerable.Range(1, kundentxt.Length - 1), kundeOrtList.Select(s => s.ort).Distinct());
